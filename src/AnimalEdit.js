...
class AnimalEdit extends Component {
    ...
    async componentDidMount() {
        if (this.props.match.params.id !== 'new') {
            ...
            const animal = await (await fetch( global.path + `/api/animal/:id/${animalId}`)).json();
    ...
    async handleSubmit(event) {
        ...
        await fetch((animal.id) ? global.path + '/api/animal/'+ animal.customersId + '/' +  animal.id : global.path + '/api/animal/new/' + customerId,{
